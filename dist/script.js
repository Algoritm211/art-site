...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizotal', '.main-prev-btn', '.main-next-btn');
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      if (!buttonPressed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight - 1) {
...
var sliders = function sliders(sliderSelector, direction, prevSelector, nextSelector) {
  var slideIndex = 1;
  var paused = false;
  var items = document.querySelectorAll(sliderSelector);
